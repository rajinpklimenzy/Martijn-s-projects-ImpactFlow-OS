...
import { Zap, Home, Calendar, Users, Briefcase, CheckSquare, Mail, Bell, Settings, FileText, DollarSign, Sparkles, Share2, Map, Receipt, PieChart, FileSignature, Star, BookOpen, Package, ShieldCheck, History, ClipboardList } from 'lucide-react';
...
export const NAV_SYSTEM_GROUP: { id: string; label: string; icon: React.ReactNode; items: NavItem[] } = {
  ...
  items: [
    ...
    { id: 'compliance-audit-log', label: 'Compliance Audit Log', icon: <ClipboardList className="w-5 h-5" /> },
