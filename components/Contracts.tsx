                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl text-sm font-medium text-slate-900 outline-none focus:ring-4 focus:ring-indigo-100 focus:border-indigo-300 resize-none"
                    ...
                    <div className="border-2 border-dashed border-slate-200 rounded-xl p-6">
                      ...
                      {!formData.fileUrl ? (
                        ...
                        <div className="space-y-3">
                          ...
                          {formData.isGoogleDriveLinked && (
                            <div className="p-3 bg-blue-50 border-2 border-blue-200 rounded-xl flex items-center gap-2">
                              <Cloud className="w-4 h-4 text-blue-600" />
                              <span className="text-sm font-bold text-blue-900">Linked to Google Drive</span>
                            </div>
                          )}
                        </div>
                      )}
